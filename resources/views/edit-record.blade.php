    ...
    <body class="antialiased">
      ...
      <h3>Fill up the form</h3>
              ...
              @csrf
                          ...
                          <input type="date" name="birthdate" id="birthdate" value="{{$data->birthdate}}" required>
                            <br>
                          ...
                          <input type="number" name="cellphone_no" value="{{$data->cellphone_no}}"  required>
                            <br>

                          <label>Address </label>
                          <textarea name="address" id="address" placeholder="{{$data->address}}" required></textarea>
                            <br>
